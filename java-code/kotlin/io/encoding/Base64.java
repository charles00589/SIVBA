    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i4 == i && i3 + 3 < endIndex) {
                int i6 = i3 + 4;
                int i7 = (access$getBase64UrlDecodeMap$p[source[i3 + 1] & UByte.MAX_VALUE] << 12) | (access$getBase64UrlDecodeMap$p[source[i3] & UByte.MAX_VALUE] << 18) | (access$getBase64UrlDecodeMap$p[source[i3 + 2] & UByte.MAX_VALUE] << 6) | access$getBase64UrlDecodeMap$p[source[i3 + 3] & UByte.MAX_VALUE];
                if (i7 >= 0) {
