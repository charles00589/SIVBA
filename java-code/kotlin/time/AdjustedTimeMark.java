...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1806minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1952minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1805elapsedNowUwyO8pc() {
        return Duration.m1850minusLRDsOJo(this.mark.mo1805elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1808plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1851plusLRDsOJo(this.adjustment, duration), null);
    }
}
