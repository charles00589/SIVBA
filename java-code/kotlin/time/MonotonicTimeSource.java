...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1955boximpl(m1949markNowz9LOYto());
    }
    ...
    public long m1949markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1958constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1948elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1947differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m1946adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1958constructorimpl(LongSaturatedMathKt.m1944saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
