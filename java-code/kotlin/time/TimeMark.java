...
public interface TimeMark {
    ...
    TimeMark mo1806minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1808plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1953plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1952minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1808plusLRDsOJo(Duration.m1868unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1848isNegativeimpl(timeMark.mo1805elapsedNowUwyO8pc());
        }
