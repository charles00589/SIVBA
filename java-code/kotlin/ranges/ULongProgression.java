...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m709toStringimpl(this.first)).append("..").append((Object) ULong.m709toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m709toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m709toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
