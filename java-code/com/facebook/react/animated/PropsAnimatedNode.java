...
public final class PropsAnimatedNode extends AnimatedNode {
    ...
    public final View getConnectedView() {
        ...
        try {
            ...
            UIManager uIManager = this.connectedViewUIManager;
            m488constructorimpl = Result.m488constructorimpl(uIManager != null ? uIManager.resolveView(this.connectedViewTag) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m488constructorimpl = Result.m488constructorimpl(ResultKt.createFailure(th));
        }
        return (View) (Result.m494isFailureimpl(m488constructorimpl) ? null : m488constructorimpl);
    }
