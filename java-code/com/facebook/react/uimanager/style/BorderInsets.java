...
public final class BorderInsets {
    ...
    public final RectF resolve(int layoutDirection, Context context) {
        ...
        if (layoutDirection == 0) {
            ...
            rectF = new RectF(floatValue, floatValue2, floatValue3, (f4 == null && (f4 = this.edgeInsets[LogicalEdge.BOTTOM.ordinal()]) == null && (f4 = this.edgeInsets[LogicalEdge.BLOCK.ordinal()]) == null && (f4 = this.edgeInsets[LogicalEdge.VERTICAL.ordinal()]) == null && (f4 = this.edgeInsets[LogicalEdge.ALL.ordinal()]) == null) ? 0.0f : f4.floatValue());
            ...
            if (I18nUtil.INSTANCE.getInstance().doLeftAndRightSwapInRTL(context)) {
                ...
                rectF = new RectF(floatValue4, floatValue5, floatValue6, (f8 == null && (f8 = this.edgeInsets[LogicalEdge.BOTTOM.ordinal()]) == null && (f8 = this.edgeInsets[LogicalEdge.BLOCK.ordinal()]) == null && (f8 = this.edgeInsets[LogicalEdge.VERTICAL.ordinal()]) == null && (f8 = this.edgeInsets[LogicalEdge.ALL.ordinal()]) == null) ? 0.0f : f8.floatValue());
            } else {
                ...
                rectF = new RectF(floatValue7, floatValue8, floatValue9, (f12 == null && (f12 = this.edgeInsets[LogicalEdge.BOTTOM.ordinal()]) == null && (f12 = this.edgeInsets[LogicalEdge.BLOCK.ordinal()]) == null && (f12 = this.edgeInsets[LogicalEdge.VERTICAL.ordinal()]) == null && (f12 = this.edgeInsets[LogicalEdge.ALL.ordinal()]) == null) ? 0.0f : f12.floatValue());
            }
        } else {
