...
public final class BorderColors {
    ...
    public static final /* synthetic */ BorderColors m441boximpl(Integer[] numArr) {
        return new BorderColors(numArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static Integer[] m442constructorimpl(Integer[] edgeColors) {
        Intrinsics.checkNotNullParameter(edgeColors, "edgeColors");
        return edgeColors;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m444equalsimpl(Integer[] numArr, Object obj) {
        return (obj instanceof BorderColors) && Intrinsics.areEqual(numArr, ((BorderColors) obj).m449unboximpl());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m445equalsimpl0(Integer[] numArr, Integer[] numArr2) {
        return Intrinsics.areEqual(numArr, numArr2);
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m446hashCodeimpl(Integer[] numArr) {
        return Arrays.hashCode(numArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m448toStringimpl(Integer[] numArr) {
        return "BorderColors(edgeColors=" + Arrays.toString(numArr) + ")";
    }

    public boolean equals(Object obj) {
        return m444equalsimpl(this.edgeColors, obj);
    }

    public int hashCode() {
        return m446hashCodeimpl(this.edgeColors);
    }

    public String toString() {
        return m448toStringimpl(this.edgeColors);
    }

    /* renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Integer[] m449unboximpl() {
    ...
    public static /* synthetic */ Integer[] m443constructorimpl$default(Integer[] numArr, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            numArr = new Integer[LogicalEdge.values().length];
        }
        return m442constructorimpl(numArr);
    }
    ...
    public static final ColorEdges m447resolveimpl(Integer[] numArr, int i, Context context) {
