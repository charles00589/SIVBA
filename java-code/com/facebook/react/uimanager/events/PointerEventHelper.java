...
public final class PointerEventHelper {
    ...
    */
    public static final int getEventCategory(String pointerEventType) {
        ...
        switch (pointerEventType.hashCode()) {
            ...
            case -1780335505:
                ...
                break;
            case -1304584214:
                return !pointerEventType.equals(POINTER_DOWN) ? 2 : 3;
            case -1304316135:
    ...
    public final boolean isExitEvent(String eventName) {
        int hashCode;
        return eventName != null && ((hashCode = eventName.hashCode()) == -1780335505 ? eventName.equals(POINTER_LEAVE) : !(hashCode == -1065042973 ? !eventName.equals(POINTER_UP) : !(hashCode == 1343400710 && eventName.equals(POINTER_OUT))));
    }
