...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2043scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2043scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
            ...
            while (true) {
                ...
                if (i >= 16) {
                    ...
                    if (this.dispatcher.isDispatchNeeded(limitedDispatcher)) {
                        this.dispatcher.mo2042dispatch(limitedDispatcher, this);
                        return;
                    }
                }
            }
    ...
    public void mo2042dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2042dispatch(this, this);
    }
