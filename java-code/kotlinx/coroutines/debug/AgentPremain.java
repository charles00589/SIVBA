...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m488constructorimpl = Result.m488constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m488constructorimpl = Result.m488constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m494isFailureimpl(m488constructorimpl) ? null : m488constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2019installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2019installSignalHandler$lambda1(Signal signal) {
