...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2043scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1980delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1981toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1981toDelayMillisLRDsOJo(long j) {
        if (Duration.m1814compareToLRDsOJo(j, Duration.INSTANCE.m1918getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1833getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
