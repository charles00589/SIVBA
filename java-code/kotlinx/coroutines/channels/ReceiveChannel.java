...
public interface ReceiveChannel<E> {
    ...
    Object mo1994receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1995tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1995tryReceivePtdJZtk = receiveChannel.mo1995tryReceivePtdJZtk();
            if (ChannelResult.m2011isSuccessimpl(mo1995tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2007getOrThrowimpl(mo1995tryReceivePtdJZtk);
            }
            Throwable m2005exceptionOrNullimpl = ChannelResult.m2005exceptionOrNullimpl(mo1995tryReceivePtdJZtk);
            if (m2005exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m2005exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo1994receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo1994receiveCatchingJP2dKIU = receiveChannel.mo1994receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo1994receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo1994receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    }
                    return ChannelResult.m2006getOrNullimpl(mo1994receiveCatchingJP2dKIU);
                }
            }
