...
public interface SendChannel<E> {
    ...
    Object mo1996trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1996trySendJP2dKIU = sendChannel.mo1996trySendJP2dKIU(e);
            if (ChannelResult.m2011isSuccessimpl(mo1996trySendJP2dKIU)) {
                return true;
            }
            Throwable m2005exceptionOrNullimpl = ChannelResult.m2005exceptionOrNullimpl(mo1996trySendJP2dKIU);
